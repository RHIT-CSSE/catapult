...
class Game:
    def __init__(self):
        ...
        self.paddle_bottom = Paddle(self.screen, 50, 250)
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, screen):
        ...
        self.rect = pygame.draw.circle(self.screen, self.ball_color,  (70, 70), self.radius, 0) # Values can be changed as needed. Example values
...
class Paddle(pygame.sprite.Sprite):
    def __init__(self, screen, x_loc, y_loc):
        pygame.sprite.Sprite.__init__(self)
        self.screen = screen
