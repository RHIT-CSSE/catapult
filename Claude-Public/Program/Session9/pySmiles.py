# Moving smiley program to illustrate objects and how they cna interact.
...
class Smiley:
    ...
    def draw(self, surface):
        ...
        pygame.draw.circle(surface,pygame.Color('black'),self.centerPoint,self.size,self.size/16)
